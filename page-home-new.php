...
<div class="fre-perfect-freelancer">
	<div class="container">
		<h2 id="title_freelance"><?php echo get_theme_mod("title_freelance") ? get_theme_mod("title_freelance") : __('Bulletin Board of top lawyers', ET_DOMAIN);?></h2>
		<?php get_template_part( 'home-list', 'bulletins' );?>
		<div class="fre-perfect-freelancer-more">
			<a class="fre-btn-o primary-color" href="<?php echo get_site_url() . '/?page_id=' . get_page_id('bulletins'); ?>"><?php _e('See all posts', ET_DOMAIN);?></a>
		</div>
	</div>
</div>
<!-- Bulletin Board -->
